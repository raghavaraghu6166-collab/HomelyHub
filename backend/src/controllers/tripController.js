...
// validate the requ info
// send info to out AI trip planner
//calculate the budget per night
// search mongodb for suitable properties
// send both AI trip + matching properties back to the frontend/user
    ...
    try{
        ...
        if(!destination || !budget || !days || !people){
            return res.status(400).json({
                status:"fail",
                message:"Please fill in the destination,budget,day,people"
            })
        }
